...
public class WebConfig {
    @Bean // Erstellt ein Bean für die Anwendung. Um ein Komponent (z. B. einen Service) zu definieren, der automatisch mit anderen Komponenten verbunden werden kann
    public CorsFilter corsFilter() {
        ...
        config.addAllowedOriginPattern("*");        config.addAllowedHeader("*");                            // Erlaubt alle Kopfzeilen
